...
internal class ConsensusStrategyHelper
{
    public static IEnumerable<BettingSuggestion> GetSuggestions(IEnumerable<SportEvent> events)
    {
        if (events is null)
        {
    ...
    public static KeyValuePair<string, double> GetConsensusWinner(SportEvent sportEvent)
    {
    ...
    public static KeyValuePair<string, double> GetBestOdd(SportEvent sportEvent, string winner)
    {
        if (sportEvent is null)
        {
            throw new ArgumentNullException(nameof(sportEvent));
    ...
    public static Statistics GetStatistics(IEnumerable<BettingSuggestion> suggestions)
    {
