...
internal class OriginalUpcomingEventConverter
{
    ...
    public void ToUpcomingEvents_WithOriginalEventData_ReturnsEventResult()
    {
        ...
        const string expectedHomeTeam = "homeTeam";
        const string expectedAwayTeam = "awayTeam";
        var expectedId = Guid.NewGuid().ToString();
        const string expectedBookmaker = "bookmaker";
        const double expectedHomeScore = 1.1;
        const double expectedAwayScore = 1.2;
        const double expectedDrawScore = 1.3;
    ...
    [Test]
    public void ToUpcomingEvents_WithPartialBookmakerData_ReturnsPartialEventResult()
    {
        // Arrange
        var expectedCommenceTime = DateTime.UtcNow;
        const string expectedHomeTeam = "homeTeam";
        ...
        var originalEvent = new Anonymous2
        {
            ...
            [
                ...
                new Bookmakers { Key = "thirdBookmaker", Markets = [] }
            ]
        };
